...
import com.hdpsolutions.docbaotest.adapter.SaveAdapter;
...
public class SaveActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    @Bind(R.id.lvSaved)
    ListView listView;
    @Bind(R.id.edtSavedKey)
    EditText editText;
    @Bind(R.id.ibSaveDelete)
    ImageButton imageButton;
    @Bind(R.id.saved_swipe_refresh_layout)
